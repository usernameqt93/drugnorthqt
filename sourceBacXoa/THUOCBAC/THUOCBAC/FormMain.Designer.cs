namespace THUOCBAC {
  partial class FormMain {
	...
	private void InitializeComponent() {
	  ...
	  this.buttonItemXemGiaThuoc = new DevComponents.DotNetBar.ButtonItem();
	  this.ribbonBar1 = new DevComponents.DotNetBar.RibbonBar();
	  this.btnIDanhSachViThuoc = new DevComponents.DotNetBar.ButtonItem();
	  this.btnIDanhSachDonHang = new DevComponents.DotNetBar.ButtonItem();
	  this.btnIDanhSachKhachHang = new DevComponents.DotNetBar.ButtonItem();
	  this.ribbonPanel2 = new DevComponents.DotNetBar.RibbonPanel();
	  this.ribbonBar2 = new DevComponents.DotNetBar.RibbonBar();
	  this.buttonItemDonXinXacNhan = new DevComponents.DotNetBar.ButtonItem();
	  this.ribbonPanel3 = new DevComponents.DotNetBar.RibbonPanel();
	  this.ribbonBar3 = new DevComponents.DotNetBar.RibbonBar();
	  this.buttonItemThongTinInAn = new DevComponents.DotNetBar.ButtonItem();
	  ...
	  this.ribbonControl1.Size = new System.Drawing.Size(1347, 154);
	  ...
	  this.ribbonPanel1.Size = new System.Drawing.Size(1347, 98);
	  // 
	  // 
	  // 
	  ...
	  this.ribbonBar4.Items.AddRange(new DevComponents.DotNetBar.BaseItem[] {
            this.buttonItemXemGiaThuoc});
	  this.ribbonBar4.Location = new System.Drawing.Point(251, 0);
	  this.ribbonBar4.Name = "ribbonBar4";
	  this.ribbonBar4.Size = new System.Drawing.Size(89, 95);
	  this.ribbonBar4.Style = DevComponents.DotNetBar.eDotNetBarStyle.StyleManagerControlled;
	  this.ribbonBar4.TabIndex = 1;
	  this.ribbonBar4.Text = "Chức năng";
	  // 
	  // 
	  // 
	  ...
	  // 
	  // buttonItemXemGiaThuoc
	  // 
	  this.buttonItemXemGiaThuoc.Image = global::THUOCBAC.Properties.Resources._48x48chartSearchIcon;
	  this.buttonItemXemGiaThuoc.ImagePaddingHorizontal = 30;
	  this.buttonItemXemGiaThuoc.ImagePosition = DevComponents.DotNetBar.eImagePosition.Top;
	  this.buttonItemXemGiaThuoc.Name = "buttonItemXemGiaThuoc";
	  this.buttonItemXemGiaThuoc.SubItemsExpandWidth = 14;
	  this.buttonItemXemGiaThuoc.Text = "Xem giá thuốc";
	  this.buttonItemXemGiaThuoc.Click += new System.EventHandler(this.buttonItemXemGiaThuoc_Click);
	  // 
	  // ribbonBar1
	  // 
	  ...
	  this.ribbonBar1.Items.AddRange(new DevComponents.DotNetBar.BaseItem[] {
            this.btnIDanhSachViThuoc,
            this.btnIDanhSachDonHang,
            this.btnIDanhSachKhachHang});
	  this.ribbonBar1.Location = new System.Drawing.Point(3, 0);
	  this.ribbonBar1.Name = "ribbonBar1";
	  this.ribbonBar1.Size = new System.Drawing.Size(248, 95);
	  this.ribbonBar1.Style = DevComponents.DotNetBar.eDotNetBarStyle.StyleManagerControlled;
	  this.ribbonBar1.TabIndex = 0;
	  this.ribbonBar1.Text = "Danh sách";
	  // 
	  // 
	  // 
	  ...
	  // btnIDanhSachViThuoc
	  // 
	  this.btnIDanhSachViThuoc.Image = global::THUOCBAC.Properties.Resources.LeafIcon48x48;
	  this.btnIDanhSachViThuoc.ImagePaddingHorizontal = 30;
	  this.btnIDanhSachViThuoc.ImagePosition = DevComponents.DotNetBar.eImagePosition.Top;
	  this.btnIDanhSachViThuoc.Name = "btnIDanhSachViThuoc";
	  this.btnIDanhSachViThuoc.SubItemsExpandWidth = 14;
	  this.btnIDanhSachViThuoc.Text = "Vị thuốc";
	  this.btnIDanhSachViThuoc.Click += new System.EventHandler(this.btnIDanhSachViThuoc_Click);
	  // 
	  // btnIDanhSachDonHang
	  // 
	  this.btnIDanhSachDonHang.Image = global::THUOCBAC.Properties.Resources.OrderIcon48x48;
	  this.btnIDanhSachDonHang.ImagePaddingHorizontal = 30;
	  this.btnIDanhSachDonHang.ImagePosition = DevComponents.DotNetBar.eImagePosition.Top;
	  this.btnIDanhSachDonHang.Name = "btnIDanhSachDonHang";
	  this.btnIDanhSachDonHang.SubItemsExpandWidth = 14;
	  this.btnIDanhSachDonHang.Text = "Đơn hàng";
	  this.btnIDanhSachDonHang.Click += new System.EventHandler(this.btnIDanhSachDonHang_Click);
	  // 
	  // btnIDanhSachKhachHang
	  // 
	  this.btnIDanhSachKhachHang.Image = global::THUOCBAC.Properties.Resources._48x48UserFilesIcon;
	  this.btnIDanhSachKhachHang.ImagePaddingHorizontal = 30;
	  this.btnIDanhSachKhachHang.ImagePosition = DevComponents.DotNetBar.eImagePosition.Top;
	  this.btnIDanhSachKhachHang.Name = "btnIDanhSachKhachHang";
	  this.btnIDanhSachKhachHang.SubItemsExpandWidth = 14;
	  this.btnIDanhSachKhachHang.Text = "Khách hàng";
	  this.btnIDanhSachKhachHang.Click += new System.EventHandler(this.btnIDanhSachKhachHang_Click);
	  // 
	  // ribbonPanel2
	  // 
	  ...
	  this.ribbonPanel2.Size = new System.Drawing.Size(1347, 98);
	  // 
	  // 
	  // 
	  ...
	  this.ribbonBar2.Items.AddRange(new DevComponents.DotNetBar.BaseItem[] {
            this.buttonItemDonXinXacNhan});
	  this.ribbonBar2.Location = new System.Drawing.Point(3, 0);
	  this.ribbonBar2.Name = "ribbonBar2";
	  this.ribbonBar2.Size = new System.Drawing.Size(182, 95);
	  this.ribbonBar2.Style = DevComponents.DotNetBar.eDotNetBarStyle.StyleManagerControlled;
	  this.ribbonBar2.TabIndex = 0;
	  this.ribbonBar2.Text = "Văn bản";
	  // 
	  // 
	  // 
	  ...
	  // 
	  // buttonItemDonXinXacNhan
	  // 
	  this.buttonItemDonXinXacNhan.Image = global::THUOCBAC.Properties.Resources.Clipboard_icon48x48;
	  this.buttonItemDonXinXacNhan.ImagePaddingHorizontal = 50;
	  this.buttonItemDonXinXacNhan.ImagePosition = DevComponents.DotNetBar.eImagePosition.Top;
	  this.buttonItemDonXinXacNhan.Name = "buttonItemDonXinXacNhan";
	  this.buttonItemDonXinXacNhan.SubItemsExpandWidth = 14;
	  this.buttonItemDonXinXacNhan.Text = "Đơn xin xác nhận";
	  this.buttonItemDonXinXacNhan.Visible = false;
	  this.buttonItemDonXinXacNhan.Click += new System.EventHandler(this.buttonItemDonXinXacNhan_Click);
	  // 
	  // ribbonPanel3
	  // 
	  ...
	  this.ribbonPanel3.Size = new System.Drawing.Size(1347, 98);
	  // 
	  // 
	  // 
	  ...
	  // 
	  // buttonItemThongTinInAn
	  // 
	  this.buttonItemThongTinInAn.Image = global::THUOCBAC.Properties.Resources.print_icon48x48;
	  this.buttonItemThongTinInAn.ImagePaddingHorizontal = 30;
	  this.buttonItemThongTinInAn.ImagePosition = DevComponents.DotNetBar.eImagePosition.Top;
	  this.buttonItemThongTinInAn.Name = "buttonItemThongTinInAn";
	  this.buttonItemThongTinInAn.SubItemsExpandWidth = 14;
	  this.buttonItemThongTinInAn.Text = "Thông tin in ấn";
	  this.buttonItemThongTinInAn.Click += new System.EventHandler(this.buttonItemThongTinInAn_Click);
	  // 
	  // applicationButton1
	  // 
	  ...
	  this.ribbonTabItem1.Text = "Danh mục";
	  // 
	  // ribbonTabItem2
	  // 
	  this.ribbonTabItem2.Name = "ribbonTabItem2";
	  this.ribbonTabItem2.Panel = this.ribbonPanel2;
	  this.ribbonTabItem2.Text = "Văn bản";
	  // 
	  // ribbonTabItem3
	  // 
	  this.ribbonTabItem3.Name = "ribbonTabItem3";
	  this.ribbonTabItem3.Panel = this.ribbonPanel3;
	  this.ribbonTabItem3.Text = "Cài đặt";
	  // 
	  // qatCustomizeItem1
	  // 
	...
	private DevComponents.DotNetBar.ButtonItem btnIDanhSachDonHang;
	private DevComponents.DotNetBar.ButtonItem btnIDanhSachViThuoc;
	...
	private DevComponents.DotNetBar.ButtonX btnXXemChiTietDSDonHang;
	private DevComponents.DotNetBar.RibbonPanel ribbonPanel3;
	private DevComponents.DotNetBar.RibbonTabItem ribbonTabItem3;
	private DevComponents.DotNetBar.RibbonBar ribbonBar3;
	private DevComponents.DotNetBar.ButtonItem buttonItemThongTinInAn;
