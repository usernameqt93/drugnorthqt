namespace THUOCBAC.FormChucNang {
  partial class frmThemDonHangNangCap {
	/// <summary>
	...
	private void InitializeComponent() {
	  ...
	  System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmThemDonHangNangCap));
	  ...
	  this.Name = "frmThemDonHangNangCap";
	  this.ShowInTaskbar = false;
	  this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
	  this.Text = "Đơn hàng";
	  this.Load += new System.EventHandler(this.frmThemDonHangNangCap_Load);
	  this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmThemDonHangNangCap_KeyDown);
